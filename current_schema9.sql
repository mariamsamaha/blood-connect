...
\restrict VXYAFzuMU8ThxgnXAbyH4F5J4BqhTFWhQKIbSlxbKrKfOoDWQjdc43etFEPPLca
...
CREATE UNIQUE INDEX idx_one_active_request_per_requester ON public.blood_requests USING btree (requester_id) WHERE ((status = ANY (ARRAY['active'::text, 'in_progress'::text])) AND (is_auto_request = false));
...
--
-- Name: idx_requests_active_not_expired; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_requests_active_not_expired ON public.blood_requests USING btree (status, expires_at) WHERE (status = 'active'::text);
...
--
-- Name: idx_requests_blood_type_upper; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_requests_blood_type_upper ON public.blood_requests USING btree (upper((blood_type)::text));
...
--
-- Name: idx_users_role_donor_status_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_users_role_donor_status_active ON public.users USING btree (role, donor_status, is_active) WHERE (role = 'donor'::text);
...
\unrestrict VXYAFzuMU8ThxgnXAbyH4F5J4BqhTFWhQKIbSlxbKrKfOoDWQjdc43etFEPPLca
